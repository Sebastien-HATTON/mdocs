...
module.exports = function (app) {
  ...
  app.post('/provisioning', function(req, res) {
    ...
    switch (provisioningRequest.strategy) {
      case 'office365':
        provisioningRequest.options.client_id =     process.env.OFFICE365_APPS_CLIENTID;
        provisioningRequest.options.client_secret = process.env.OFFICE365_APPS_CLIENTSECRET;
